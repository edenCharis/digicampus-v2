  ...
  return (
    <main className="lp-root">
      <style>{`
        ...
        @keyframes glow {
          0%, 100% { box-shadow: 0 0 30px rgba(26,175,230,0.2); }
          50%       { box-shadow: 0 0 50px rgba(26,175,230,0.4); }
        }
        ...
        .lp-grid {
          ...
          background-image:
            linear-gradient(rgba(26,175,230,1) 1px, transparent 1px),
            linear-gradient(90deg, rgba(26,175,230,1) 1px, transparent 1px);
        ...
        .lp-orb1 {
          ...
          background: radial-gradient(circle, rgba(26,175,230,0.1) 0%, transparent 65%);
        ...
        .lp-headline em { font-style: normal; color: #1AAFE6; }
        .lp-desc {
        ...
        .lp-feat-icon {
          ...
          border: 1px solid rgba(26,175,230,0.15);
          display: flex; align-items: center; justify-content: center;
          font-size: 1rem;
        }
        ...
        .lp-stat-dot {
          width: 8px; height: 8px; border-radius: 50%; background: #1AAFE6;
          box-shadow: 0 0 8px rgba(26,175,230,0.8); flex-shrink: 0;
        }
        .lp-stat-info { }
        ...
        .lp-form-eyebrow {
          font-size: 0.7rem; font-weight: 700; color: #1AAFE6; letter-spacing: 0.1em;
          text-transform: uppercase; margin-bottom: 0.625rem;
          display: flex; align-items: center; gap: 0.5rem;
        }
        .lp-form-eyebrow::before {
          content: ''; display: block; width: 20px; height: 2px;
          background: #1AAFE6; border-radius: 1px;
        }
        .lp-form-title {
        ...
        .lp-input:focus {
          border-color: rgba(26,175,230,0.5);
          background: rgba(26,175,230,0.04);
        }
        .lp-pwd-btn {
        ...
        .lp-submit {
          ...
          background: linear-gradient(135deg, #1AAFE6, #0E8FBF);
          ...
          box-shadow: 0 4px 20px rgba(26,175,230,0.3);
        }
        .lp-submit:hover:not(:disabled) { opacity: 0.92; transform: translateY(-1px); box-shadow: 0 6px 24px rgba(26,175,230,0.4); }
