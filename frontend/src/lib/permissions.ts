...
export const ROUTE_ROLES: Record<string, Role[]> = {
  ...
  '/enseignant/ecues':      ['enseignant'],
  '/enseignant/classes':    ['enseignant'],
  '/enseignant/annee':      ['enseignant'],
  '/professeur': ['professeur'],
  '/cours':      ['cours', 'enseignant', 'professeur'],
  '/inscription':['inscription', 'scolarité'],
  '/anonymat':   ['anonymat'],
  '/personnel':                  ['personnel'],
  '/personnel/agents':           ['personnel'],
  '/personnel/enseignants':      ['personnel'],
  '/personnel/conges':           ['personnel'],
  '/personnel/departements':     ['personnel'],
...
export const ROLE_NAV: Record<Role, string[]> = {
  ...
  enseignant: ['/enseignant', '/enseignant/ecues', '/enseignant/classes', '/enseignant/annee', '/cours'],
  professeur: ['/professeur', '/cours'],
  cours: ['/cours'],
  inscription: ['/inscription'],
  anonymat: ['/anonymat'],
  personnel: ['/personnel', '/personnel/agents', '/personnel/enseignants', '/personnel/conges', '/personnel/departements'],
  gesnote: ['/gesnote'],
  soutenance: ['/soutenance'],
  suivi: ['/suivi'],
  caisse: ['/caisse'],
